...
import { canonExplorerProperties, flattenCanonExplorerProperties, locationEntities, propertySupportsDialogueTrigger } from "../explorerSchema.js";
...
function EventConfiguration({ context }: { context: EventConfigContext }) {
  ...
  const selectableLocations = useMemo(() => locationEntities(project), [project]);
